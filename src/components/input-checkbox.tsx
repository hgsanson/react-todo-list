...
export const inputCheckboxVariants = cva(
	"appearance-none peer flex items-center justify-center transition cursor-pointer overflow-hidden",
	{
		variants: {
			variant: {
				none: "",
...
export const inputCheckboxIconVariants = cva(
	"absolute top-1/2 left-1 -translate-y-1/2 hidden peer-checked:block fill-white cursor-pointer",
	{
		variants: {
			size: {
				md: "w-3 h-3",
